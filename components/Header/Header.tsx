        ...
        <div className="flex flex-col">
          <div className="bg-paper-bg bg-cover h-11 drop-shadow-[0_-7px_5px_rgba(0,0,0,0.31)] bg-opacity-10">
            <div className="flex justify-around items-center md:justify-between lg:mx-36">
              ...
              <Link href="/cart">
                <a>
                  <div className="ml-10 mb-3 cursor-pointer sm:block relative sm:absolute top-2 sm:top-3 right-3 lg:right-20 sm:rounded-full sm:bg-white md:border-text-secondary sm:bg-opacity-100 md:shadow-text-primary md:shadow-md md:w-[65px] md:h-[65px]">
                    {cartItems?.length > 0 ? (
                    ...
                    {cartItems?.length > 0 && (
                      <div className="absolute -top-2 sm:-top-1 -left-1 bg-shopping-cart-badge w-5 h-5 rounded-full justify-center items-center flex text-white">
                        {cart.length}
                      </div>
                    )}
                  </div>
