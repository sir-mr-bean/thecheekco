...
const GiftOption = () => {
  ...
  return (
    <>
      <div className=" flex h-36 w-full items-center justify-center border border-y-text-secondary border-x-transparent">
        <span className="text-center text-sm text-text-secondary sm:text-lg">
          Cheeky Box set to be shipped in {daysUntilNextMonth} days, on{" "}
          {nextMonth7thCalendar}
        </span>
      </div>
