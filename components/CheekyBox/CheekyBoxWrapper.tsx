...
const CheekyBoxWrapper = () => {
  ...
  return (
    <>
      <div className="bg-white mt-16 mx-1 md:mx-16 rounded-md shadow-sm shadow-black font-gothic text-text-primary overflow-visible ">
        <div className="mx-auto px-4 pt-4 pb-16 sm:px-6 sm:pt-8 sm:pb-24 lg:px-8 xl:px-2 xl:pt-4">
          <div className="flex-1 flex flex-col justify-between py-12 px-4 sm:px-6 h-[75vh]">
            ...
            <div
              className="flex items-start overflow-visible w-72 sm:w-full"
              ref={wrapper}
            >
            ...
            <div className={`mt-2`}>
              ...
              >
                ...
                <ol className="mx-2 sm:mx-8 flex items-center space-x-1 sm:space-x-5">
                  {steps.map((step, i) => (
                    <li key={`step_${i}`}>
