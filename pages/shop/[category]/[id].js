    ...
    <>
      {product && (
        <div className="font-gothic">
          <div className="mx-auto py-16 px-4 sm:py-12 sm:px-6 lg:max-w-5xl lg:px-8 space-y-6">
            {/* Product */}
            <div className="flex flex-col sm:flex-row border justify-center sm:items-stretch sm:space-x-5 space-y-5">
              ...
              <div className="max-w-xl sm:max-w-none border rounded-lg w-full bg-white sm:px-10 flex flex-col justify-center items-center">
                ...
                <div className="flex justify-between items-center space-x-10">
                  <button
                    type="button"
                    className="mt-3 uppercase bg-indigo-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500"
                  >
                    Add to cart
                  </button>
                  <div>
                ...
                <div className="border-t border-gray-200 mt-10 pt-10 flex justify-evenly items-center w-full">
                  <span className="text-black pt-5 text-2xl">
